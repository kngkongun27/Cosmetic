...
<head>
    ...
    <meta name="description" content="Đây là đồ án nhỏ được code bởi kngkongun.">
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="{{ asset('storage/user/' . (Auth::user()->avatar ?? 'default-avatar.jpg')) }}" alt="Hello">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle" src="{{ asset('storage/user/' . (Auth::user()->avatar ?? 'default-avatar.jpg')) }}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href="./admin/logout" class="btn-pill btn-shadow btn-shine btn btn-focus">Đăng Xuất</a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="./admin/statistical" class="{{ (request()->segment(2) == 'statistical') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Bảng thống kê
                                        </a>
                                    </li>
                                </ul>
                            </li>
